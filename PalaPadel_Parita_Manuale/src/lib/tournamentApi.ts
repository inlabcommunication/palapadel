...
export const updateTournamentGroupTeam = (tournamentId: string, entryId: string, fields: { played: number; won: number; lost: number; points: number; order: number; qualified: boolean; qualificationBracket?: "gold" | "silver" | null }) =>
