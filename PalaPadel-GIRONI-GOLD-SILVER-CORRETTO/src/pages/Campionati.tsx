          ...
          {contentTab === "standings" ? (
            <>
              ...
              {!isAdmin && edition.bracketEnabled && (
                <button onClick={() => setContentTab("bracket")} className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg border border-[#BBFF5E] px-4 py-3 text-sm font-bold text-[#BBFF5E]">
