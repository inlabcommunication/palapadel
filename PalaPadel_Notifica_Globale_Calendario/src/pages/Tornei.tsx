...
import { ChevronLeft, Pencil, Plus, Trash2, Trophy, Users, X } from "lucide-react";
      ...
      <div className="mb-5 border-b border-[rgba(251,243,222,0.12)] pb-5">
        ...
        {tournament.logoUrl && (
          <div className="mt-5 flex justify-center">
            <img src={tournament.logoUrl} alt={tournament.logoAlt ?? `Logo ${tournament.name}`} className="h-28 w-28 object-contain sm:h-32 sm:w-32" />
          </div>
        )}
      </div>
