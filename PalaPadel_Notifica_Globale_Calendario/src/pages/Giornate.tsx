...
export function GiornatePage() {
  ...
  const [activeTab, setActiveTab] = useState<"standings" | "bracket" | "calendar">("calendar");
  ...
  return (
    <div className="p-4 pb-6">
      ...
      <div className="hidden" role="tablist" aria-label="Area campionato">
      ...
      <div className="mb-4 mt-3 flex items-center gap-2 border-b border-[rgba(251,243,222,0.12)] pb-3">
        <CalendarDays size={17} className="text-[#BBFF5E]" />
        <h3 className="text-sm font-extrabold uppercase text-[#FBF3DE]">Gestisci calendario</h3>
      </div>
